...
contract Testt {
    ...
    Split[] public accounts;

    function OnlyOwnerInherit(address payable[] memory _payees,uint256[] memory _shares,string memory _colabwith) external payable{
                 Split account = new Split( _payees,_shares,_colabwith);
